...
class RegisterViewController: UIViewController {
    ...
    private let nameTextField: UITextField = {
        ...
        textField.applyCustomTF(placeholder: "Ad")
        return textField
    }()
    
    private let surnameTextField: UITextField = {
        let textField = UITextField()
        textField.applyCustomTF(placeholder: "Soyad")
        return textField
    }()
    ...
    private let confirmPasswordTextField: UITextField = {
        let textField = UITextField()
        textField.applyCustomTF(placeholder: "Şifrəni təsdiqlə")
        return textField
    }()
    ...
    private lazy var backToLoginBtn: UIButton = {
        let button = UIButton(type: .system)
        button.attributedTitle(firstTitle: "Hesabın mövcuddur? ", secondTitle: "Giriş et.", ofSize: 16)
